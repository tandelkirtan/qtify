...
// --------------in the below cooode card is failing and in above code Albom is failing -------------
...
// --------------------------------------------------
// --------------------------------------------------
// in below code also Card is failing -------
...
//   // For albums: when collapsed, show only 5 items in carousel, when expanded show all in grid
//   // For songs: always show all filtered data in carousel
...
//     // For albums
//     if (isCollapsed) {
//       return filteredData.slice(0, 5); // Show only 5 when collapsed
//     }
    
//     return filteredData; // Show all when expanded
//   };
...
//       {/* Content */}
//       {type === "songs" ? (
//         // Songs always use Carousel with all filtered data
//         <Carousel
//           data={visibleData}
//           renderComponent={(item) => (
//             <Card 
...
//         />
//       ) : (
//         // Albums: use Carousel when collapsed, Grid when expanded
//         <>
//           {isCollapsed ? (
//             <Carousel
//               data={visibleData}
